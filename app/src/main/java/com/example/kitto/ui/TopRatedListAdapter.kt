...
class TopRatedListAdapter: RecyclerView.Adapter<TopRatedListAdapter.BaseViewHolder>(){
        ...
        return when(viewType){
            TYPE_MOVIE -> {
                ...
                val itemView = LayoutInflater.from(parent.context)
                    .inflate(R.layout.top_rated_list_item, parent, false) as View
    ...
    inner class MovieViewHolder(view: View) : BaseViewHolder(view){
        ...
        var ratingView: TextView = view.findViewById(R.id.movie_item_rating)
        ...
        override fun bind(position:Int) {
            ...
            ratingView.text = movie.vote_average
            Glide.with(mContext)
                .load(posterPath)
                .centerCrop()
