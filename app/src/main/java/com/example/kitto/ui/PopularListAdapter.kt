...
class PopularListAdapter: RecyclerView.Adapter<PopularListAdapter.BaseViewHolder>(){
        ...
        return when(viewType){
            TYPE_MOVIE -> {
                ...
                val itemView = LayoutInflater.from(parent.context)
                    .inflate(R.layout.popular_list_item, parent, false) as View
    ...
    inner class MovieViewHolder(view: View) : BaseViewHolder(view){
        ...
        var popularityView: TextView = view.findViewById(R.id.movie_item_popularity)
        ...
        override fun bind(position:Int) {
            ...
            popularityView.text = (position + 1).toString()
            Glide.with(mContext)
                .load(posterPath)
                .centerCrop()
