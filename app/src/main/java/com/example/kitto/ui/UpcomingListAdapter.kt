...
class UpcomingListAdapter: RecyclerView.Adapter<UpcomingListAdapter.BaseViewHolder>(){
        ...
        return when(viewType){
            TYPE_MOVIE -> {
                ...
                val itemView = LayoutInflater.from(parent.context)
                    .inflate(R.layout.upcoming_list_item, parent, false) as View
    ...
    inner class MovieViewHolder(view: View) : BaseViewHolder(view){
        ...
        var releaseDateView: TextView = view.findViewById(R.id.movie_item_release_date)
